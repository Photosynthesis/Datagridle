	...
	while (false !== ($file = readdir($handle)))
      ...
      continue; }
        ...
        continue;
          ...
          $errors[] = 'Couldn\'t run getimagesize()';
          continue;
          }
				$mime = $imginfo['mime'];
...
print_r($errors);
echo "total:".$total."<br />bad:$bad<br /> good: $good <br /> dup: $dup";
...
if($total>0 && $bad==$total) Header('Location: ./upload.php?type='.$_GET['type'].$passfeid.'&permerror=1&errors='.$error_string.'&total='.$total);
