...
$tinybrowser['obfuscate'] = 'ldkjsafas8457kserj';
...
$tinybrowser['path']['image'] = $cms_root_path.'/content_images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $cms_root_path.'/media/'; // Media files location
$tinybrowser['path']['file']  = $cms_root_path.'/documents/'; // Other files location
